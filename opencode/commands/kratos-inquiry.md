...
|--------------|-------------------|--------------|------|
| **Project Info** | "what does this project", "how is this organized", "explain the architecture", "describe this project" | @kratos-metis | QUICK_QUERY |
| **Git History** | "git blame", "who wrote", "when changed", "commit history", "recent changes", "recent commits", "what changed" | @kratos-clio | - |
| **Tech Stack** | "what version", "dependencies", "libraries", "tech stack", "using what" | @kratos-metis | QUICK_QUERY |
| **Best Practices** | "best practice", "how do others", "github example", "popular approach", "common pattern" | @kratos-mimir | - |
| **Documentation** | "find docs", "documentation for", "how to use", "API for", "show docs" | @kratos-mimir | - |
| **Security** | "vulnerability", "CVE", "security advisory", "security issue", "exploits" | @kratos-mimir | - |
| **Code Exploration** | "find where", "show all", "list", "locate", "where is", "search for" | @kratos-metis | QUICK_QUERY |
...
### @kratos-metis - Quick Query (Project/Tech/Code Info)
...
### @kratos-clio - Git History Analysis
...
### @kratos-mimir - External Research
...
Routing to @kratos for full pipeline...
```
