...
> **Note**: The authoritative intent classification table is in `C:/Users/shotu/.config/opencode/commands/kratos-main.md` Step 0. Inquiry mode handles only the information-seeking subset.
