...
```
.claude/.Arena/
?œâ??€ project-overview.md      # High-level summary
?œâ??€ tech-stack.md            # Languages, frameworks, deps
?œâ??€ architecture.md          # System design, patterns
?œâ??€ file-structure.md        # Directory organization
?”â??€ conventions.md           # Coding standards found
```
