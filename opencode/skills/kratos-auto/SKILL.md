---
name: kratos-auto
description: "Kratos orchestrator activated by: \"Kratos\" keyword, any god-agent name (Athena, Ares, Metis, Apollo, Artemis, Hermes, Hephaestus, Daedalus, Clio, Mimir, Hades, Odysseus, Prometheus, Themis, Nemesis, Cassandra, Hera, Ananke, Iris), \"continue\"/\"next stage\" during active pipelines, or queries about features, PRDs, specs, code reviews, and implementation. When unsure, activate."
---
